...
public class BurstCostExecutorsBenchmark extends AbstractMicrobenchmark {
    ...
    public void setup() {
        ...
        case epollEventLoop:
            ...
            EventLoopGroup epollEventLoopGroup = new MultithreadEventLoopGroup(1, EpollHandler.newFactory());
        ...
        case kqueueEventLoop:
            ...
            EventLoopGroup kQueueEventLoopGroup = new MultithreadEventLoopGroup(1, KQueueHandler.newFactory());
